...
from my_utils_CNN import FlattenLayer,train_ch5,load_data_fashion_mnist
...
conv_arch = ((1, 1, 64), (1, 64, 128), (2, 128, 256),
             (2, 256, 512), (2, 512, 512))
#经历5个vgg_block，宽高会减半5次，变成224/2^5=7
#c*h*w
fc_features = 512*7*7
